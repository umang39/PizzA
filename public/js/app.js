...
initAdmin(); //change orders status

var statuses = document.querySelectorAll('.status_line');
var hiddenInput = document.querySelector('#hiddenInput').innerText;
console.log(hiddenInput);
var order;
axios__WEBPACK_IMPORTED_MODULE_0___default().post('/getData', {
  id: hiddenInput
}).then(function (res) {
  console.log(res);
  ...
  updateStatus(order); //join socket
